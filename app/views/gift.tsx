...
export default function GiftSection() {
  ...
  return (
    <section
      ref={ref}
      className="py-12 sm:py-16 md:py-20 px-4 bg-[#722f37] text-white relative overflow-hidden"
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          <p className="text-base sm:text-lg  leading-relaxed max-w-2xl mx-auto px-4">
            Así mismo, tenemos el honor de invitarles al tradicional conteo de
            regalos que se efectuará:
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 mb-4 pb-4 border-b border-[#8B7355]/20">
            ...
            <div>
              ...
              <p className="text-2xl sm:text-3xl font-serif text-[#722f37]">
                Domingo 11
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div>
              <p className="s text-sm font-medium mb-1">Hora</p>
              <p className="text-2xl sm:text-3xl font-serif text-[#722f37]">
                12:00 hrs.
              </p>
            </div>
        ...
        >
          ...
          <p
            className="font-serif text-xl sm:text-2xl md:text-3xl  mb-6"
          ...
          {/* Map Button */}
          <a
            href="https://maps.app.goo.gl/3GoPQT98iSqGWwT47"
            target="_blank"
